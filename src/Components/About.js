...
export default function AboutMe() {
  ...
  const aboutText = {
    light: {
      para1:
        "Frontend-focused Full Stack Developer with 3+ years of experience building scalable web applications using React.js, Node.js, and SQL. Strong foundation in UI development, REST API integration, and modular architecture. Proficient in agile methodologies and version control. Basic understanding of AWS services like Parameter Store, CloudWatch, and Kibana.",
      para2:
    ...
    corporate: {
      para1:
        "Frontend-focused Full Stack Developer with 3+ years of experience delivering high-impact, enterprise-grade web applications using React.js, Node.js, and SQL. Proven expertise in designing scalable, maintainable, and modular solutions that drive business success and efficiency.",
      para2:
    ...
    fun: {
      para1:
        "Frontend-focused Full Stack Developer with 3+ years of experience creating amazing web apps 🚀 using React.js, Node.js, and SQL. Passionate about clean code, interactive UIs, and making users smile 😄.",
      para2:
        ...
        <Grid container spacing={4} alignItems="center">
          <Grid item xs={12} md={12}>
            ...
            <Button
              ...
              href={process.env.PUBLIC_URL + "/Ruturaj_Kulkarni.pdf"}
              target="_blank"
            >
              Download Resume
            </Button>
